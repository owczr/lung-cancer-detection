...
from src.model.builders import ...  # TODO: Change the import statement
from src.model.director import ModelDirector


@pytest.fixture
def builder():
    return ...  # TODO: Return correct builder


@pytest.fixture
def director():
    return ModelDirector(builder=...)  # TODO: Set correct builder
